...
switch (numero) {
  case '1':
    ...
    break;
  case '2':
    alert('Si cagas durante diez minutos al día en el trabajo, al cabo del año habrás cobrado 40 horas sólo por cagar');
    break;
  case '3':
    alert('A las personas se las conoce bien con una ración de croquetas impares delante');
    break;
  case '4':
    alert(
  ...
  case '5':
    ...
    break;
  case '6':
    alert('¿A qué sistema confiarías tu vida? ¿Al Capitalista? ¿Al Comunista? ¿O al Inmunológico?');
    break;
  case '7':
    alert(
    ...
    break;
  case '8':
    alert('Todo el mundo odia las matemáticas hasta que ve algo raro en la nómina.');
    break;
  case '9':
    alert('Si Adelita se fuera con otro, respetaría su decisión y reflexionaría sobre mis errores. ');
    break;
  case '10':
    alert(
